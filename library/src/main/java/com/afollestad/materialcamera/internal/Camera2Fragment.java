...
public class Camera2Fragment extends BaseCameraFragment implements View.OnClickListener {
    ...
    public void openCamera() {
        ...
        try {
            ...
            CameraCharacteristics characteristics = manager.getCameraCharacteristics(String.valueOf(mInterface.getCurrentCameraId()));
            ...
            manager.openCamera(String.valueOf(mInterface.getCurrentCameraId()), mStateCallback, null);
